...
ENERGY_CONSUMPTION EQU 0FFFBH ; energy depleted (-5%)
ENERGY_INCREASE    EQU 000AH  ; energy gained (+10%)
...
; ----------------------------------------------------------------------------
; key_CheckUpdate: Checks if the user is holding down a key or if it's a new
; key all together.
; ----------------------------------------------------------------------------
